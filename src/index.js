...
function suggestSong(event) {
  ...
  let prompt = `Please suggest a song including the name of the artist to fit the mood the user is currently feeling from the word ${userInput.value} in basic HTML, separating each line with a <br />.`;
  let context =
